...
export const api = {
    ...
    // Catalog (Public)
    catalog: {
        getProducts: (params?: { search?: string; category?: string; category_id?: number | string; page?: number; limit?: number; sort?: 'stock_desc' | 'stock_asc' | 'price_asc' | 'price_desc' | 'newest' | string; featured?: 'home' | string }) => {
