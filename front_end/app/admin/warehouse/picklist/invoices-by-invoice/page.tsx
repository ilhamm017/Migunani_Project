...
export default function WarehouseInvoiceQueueByInvoicePage() {
      ...
      <div className="warehouse-panel bg-white px-4 md:px-6 py-4 flex flex-col gap-3 border-b border-slate-200">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h2 className="text-xl md:text-2xl font-black text-slate-900 leading-tight">Queue Picklist (Per Invoice)</h2>
            <p className="text-xs text-slate-500 mt-1">
              Tampilan per-invoice (opsional). Untuk picking, pakai tampilan global.
            </p>
            <Link
