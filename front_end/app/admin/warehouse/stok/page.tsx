...
export default function WarehouseInventoryPage() {
    ...
    return (
        <div className="warehouse-screen warehouse-screen-fill warehouse-screen-flush-bottom warehouse-screen-edge-to-edge flex min-h-0 flex-col overflow-hidden bg-slate-50 pt-3">
            {/* Stats Bar */}
