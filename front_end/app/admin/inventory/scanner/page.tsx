  ...
  return (
    <div className="p-6 space-y-5">
      <div className="bg-white border border-slate-200 rounded-[32px] p-6 shadow-sm">
        <h1 className="text-xl font-black text-slate-900">Scanner SKU</h1>
        <p className="text-sm text-slate-600 mt-1">Bisa scan via kamera browser, alat scan USB/Bluetooth, atau input manual.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <Link href="/admin/inventory/scanner" className="bg-slate-900 border border-slate-900 rounded-2xl p-4 text-sm font-bold text-white">Scanner SKU</Link>
