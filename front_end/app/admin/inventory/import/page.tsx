  ...
  return (
    <div className="p-6 space-y-5">
      <div className="bg-white border border-slate-200 rounded-[32px] p-6 shadow-sm">
        <h1 className="text-xl font-black text-slate-900">Import Excel/CSV Inventori</h1>
        <p className="text-sm text-slate-600 mt-1">Baca file dulu, edit data yang error, lalu commit ke database. Nilai negatif otomatis jadi 0.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <Link href="/admin/inventory/import" className="bg-slate-900 border border-slate-900 rounded-2xl p-4 text-sm font-bold text-white">Import Excel/CSV</Link>
      ...
      {previewRows.length > 0 && (
        <div ref={draftSectionRef} className="bg-white border border-slate-200 rounded-3xl p-5 shadow-sm">
