    ...
    return (
        <div className="p-6 space-y-8 pb-24">
            <div className="space-y-1">
                <p className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em]">Akun Admin</p>
                <h1 className="text-2xl font-black text-slate-900">Profil Administrator</h1>
            </div>
            ...
            <div className="text-center text-[10px] text-slate-400 font-medium">
                <p>Migunani Admin Panel v1.0.0</p>
