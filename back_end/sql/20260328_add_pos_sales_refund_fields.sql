...
ALTER TABLE `pos_sales`
  ...
  ADD COLUMN `refunded_by` CHAR(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL AFTER `refunded_at`,
  ADD COLUMN `refund_reason` TEXT NULL AFTER `refunded_by`,
  ADD KEY `idx_pos_sales_refunded_at` (`refunded_at`),
  ADD CONSTRAINT `fk_pos_sales_refunded_by_user` FOREIGN KEY (`refunded_by`) REFERENCES `users` (`id`) ON UPDATE CASCADE;
