...
import { Product, Category, ProductCategory, StockMutation, PurchaseOrder, Supplier, sequelize } from '../models';
...
export const createProduct = async (req: Request, res: Response) => {
    ...
    try {
        const { sku, barcode, name, description, image_url, base_price, price, unit, min_stock, category_id, stock_quantity } = req.body;
