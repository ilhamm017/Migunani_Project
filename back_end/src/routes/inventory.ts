...
router.get('/admin/suppliers', authenticateToken, authorizeRoles('super_admin', 'admin_gudang'), InventoryController.getSuppliers);
router.post('/admin/suppliers', authenticateToken, authorizeRoles('super_admin', 'admin_gudang'), InventoryController.createSupplier);
